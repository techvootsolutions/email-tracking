...
import {useFailedMessageSearch} from "@mail_activity_tracking/core/search/failed_message_search_hook.esm";
...
export class FailedMessagesPanel extends Component {
    ...
    static template = "mail_activity_tracking.FailedMessagesPanel";

...
import {FailedMessageReview} from "@mail_activity_tracking/components/failed_message_review/failed_message_review.esm";
import {MessageTracking} from "@mail_activity_tracking/components/message_tracking/message_tracking.esm";
...
export class FailedMessage extends Component {
    ...
    static template = "mail_activity_tracking.FailedMessage";
    static components = {
        RelativeTime,
        MessageTracking,
        FailedMessageReview,
